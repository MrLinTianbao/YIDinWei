...
#define FTDefaultBackColor             [UIColor colorWithRed:0 green:0 blue:0 alpha:0.2]
...
- (instancetype)init {
    ...
    if (self) {
        ...
        self.windowBackgroundColor = FTDefaultBackColor;
...
- (UIView *)backgroundView {
    if (!_backgroundView) {
        ...
        _backgroundView.backgroundColor = FTDefaultBackColor;
    }
...
- (void)show {
    ...
    [UIView animateWithDuration:FTDefaultAnimationDuration
                     animations:^{
                         ...
                         self.backgroundView.backgroundColor = FTDefaultBackColor;
                     }];
}
